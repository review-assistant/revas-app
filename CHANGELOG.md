...
### Added
- Docker deployment package (`docker/`) for containerized deployment

### Changed
- Comment service backend URL is now configurable via `COMMENT_SERVICE_URL` environment variable
